...
o                }
            ...
            switch (oracionCortada) {
                case 0:
                    escribeError('Recuerda que debes unir con "en" o "a", por ejemplo "1 milla <strong>a</strong> metros"');
                    break;
                case 1:
                    escribeError('Recuerda que no debes <strong>incluir espacios</strong> al inicio');
                    break;
            }
        }
    } else {
...
function escribeResultado(numero, u1, u2, resultado) {
    var primeraUnidadFinal = (numero === 1) ? u1 : u1 + '';
    var cadenaSegundaUnidad = (resultado === 1) ? u2 : u2 + '';
